...
pub const LC_TOKENS_OFFSET: usize = 0x4a0;
...
impl TransitionMutexGuard {
    ...
    fn claim(registers: StaticRef<lc_ctrl::regs::LcCtrl>) -> Self {
        ...
        crate::println!("[mcu-rom-lcc] Mutex successfully acquired.");
        Self { registers }
    }
}
...
impl Lifecycle {
    ...
    pub fn init(&self) -> McuResult<()> {
        crate::println!("[mcu-lcc] Initializing Lifecycle controller...");
        ...
        crate::println!("Lifecycle controller initialization done");
        Ok(())
    }
    ...
    fn transition_flow(
        ...
        crate::println!("[mcu-rom-lcc] Writing tokens: 0x{:08x}", token_31_0);
        self.registers.transition_token_0.set(token_31_0);
        crate::println!("[mcu-rom-lcc] Writing tokens: 0x{:08x}", token_63_32);
        self.registers.transition_token_1.set(token_63_32);
        crate::println!("[mcu-rom-lcc] Writing tokens: 0x{:08x}", token_95_64);
        self.registers.transition_token_2.set(token_95_64);
        crate::println!("[mcu-rom-lcc] Writing tokens: 0x{:08x}", token_127_96);
        self.registers.transition_token_3.set(token_127_96);

        // Step 3: Trigger the Transition Command
        crate::println!("[mcu-rom-lcc] Triggering transition command: 0x1",);
